...
exports.getKeyCombinations = exports.getAttributeFromTranslations = exports.getFormattedAttribute = exports.toSnakeCase = exports.getMessage = void 0;
...
function getCustomMessage(attributes, rule, customMessages, messageType, lang) {
    ...
    const translatedMessages = (0, object_1.dotify)(lang_1.default.get(lang)['custom'] || {});
    ...
    if ((0, general_1.isSizeRule)(rule)) {
        allKeys.pop();
...
function getMessage(attributes, rule, value, customMessages, hasNumericRule, lang) {
    ...
    const validationMessages = lang_1.default.get(lang);
 ...
 */
function getAttributeFromTranslations(key, lang) {
    return (0, object_1.deepFind)(lang_1.default.get(lang), `attributes.${key}`);
}
exports.getAttributeFromTranslations = getAttributeFromTranslations;
;
/**
